package com.example.hyx.appyiji.Activity.MainAddView.KongJian;
...
public class CustomDatePickerDialogFragment extends DialogFragment implements DatePicker.OnDateChangedListener, View.OnClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        currentDateAdd1= (Calendar) bundle.getSerializable(CURRENT_DATE);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view  = inflater.inflate(R.layout.activity_main_add_frm_date,container,false);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (view != null) {
            datePicker = view.findViewById(R.id.main_add_date);
            backButton = view.findViewById(R.id.main_add_date_back);
            backButton.setOnClickListener(this);
            ensureButton = view.findViewById(R.id.main_add_date_ensure);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.main_add_date_back:
                dismiss();
                break;
            case R.id.main_add_date_ensure:
