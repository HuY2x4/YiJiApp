...
import com.example.hyx.appyiji.Adapter.MyPagerAdapter_Add;
import com.example.hyx.appyiji.Fragment.main_add.CustomDatePickerDialogFragment;
import com.example.hyx.appyiji.Fragment.main_add.inFragment;
import com.example.hyx.appyiji.Fragment.main_add.outFragment;
...
//
        datebase=new MyDatebaseHelper(this,"YiJiDate.db",null,1);
        ...
        switch (view.getId()) {
            ...
            case R.id.main_add_baocun:
                ...
                if(tablayout.getSelectedTabPosition()==0){
                    ...
                    curName=outFragment.curName;
                    imgId=outFragment.curImgId;
                }
                else{
                    ...
                    curName=inFragment.curName;
                    imgId=inFragment.curImgId;
                }
