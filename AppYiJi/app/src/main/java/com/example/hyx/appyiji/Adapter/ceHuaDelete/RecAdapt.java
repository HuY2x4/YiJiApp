package com.example.hyx.appyiji.Adapter.ceHuaDelete;
...
public class RecAdapt extends BaseRecyclerViewAdapter<main_list_item> {//RecyclerView.Adapter<RecAdapt.MyHolder>
//    List<main_list_item> items;
//    private final int resourceId;
    private OnDeleteClickLister mDeleteClickListener;

    public RecAdapt(Context context, List<main_list_item> items){
    ...
    @Override
    protected void onBindData(RecyclerViewHolder holder, main_list_item bean, int position) {
...
/*@Override
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        main_list_item item = items.get(position); // 获取当前项的Fruit实例
