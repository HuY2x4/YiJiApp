package com.example.hyx.appyiji.Activity.MainView;
...
import com.example.hyx.appyiji.Activity.MainAddView.MainAddActivity;
import com.example.hyx.appyiji.Activity.MainView.DownAndUp.DealDownDataThread;
import com.example.hyx.appyiji.Activity.MainView.DownAndUp.DealUpDataThread;
import com.example.hyx.appyiji.Activity.SetView.SetActivity;
import com.example.hyx.appyiji.Activity.TestView.TestActivity;
import com.example.hyx.appyiji.Activity.LoginView.LoginActivity;
import com.example.hyx.appyiji.Activity.MainView.Adapter.MyPageAdapter.MyPagerAdapter;
import com.example.hyx.appyiji.Activity.MainView.Fragment.JZFram.JZFragment;
import com.example.hyx.appyiji.Activity.MainView.Fragment.TJFram.TJFragment;
import com.example.hyx.appyiji.R;
import com.example.hyx.appyiji.Activity.MainView.ExtendsClass.NoScrollViewPager;
...
//        }
        ...
        if (android.os.Build.VERSION.SDK_INT > 9) {  //暴力强制解决版本太高不能
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Log.d("aaaa","id:"+R.id.main_nav_set+"  idtrue:"+item.getItemId());
                switch (item.getItemId()){
                    ...
                    case R.id.main_nav_test:
                        ...
                        break;
                    case R.id.main_nav_upload:
                        new DealUpDataThread(MainActivity.this).run();
                        break;
                    case R.id.main_nav_download:
                        new DealDownDataThread(MainActivity.this).run();
                        break;
