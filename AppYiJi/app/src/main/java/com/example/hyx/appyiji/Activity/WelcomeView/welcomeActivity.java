package com.example.hyx.appyiji.Activity.WelcomeView;
...
public class welcomeActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{
    ...
    private com.example.hyx.appyiji.Activity.WelcomeView.welcomeViewPagerAdapter welcomeViewPagerAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(pref.getBoolean("hasWelcome",false)){
...
//            startActivity(intent);
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SharedPreferences.Editor editor=getSharedPreferences("YiJidata",MODE_PRIVATE).edit();
